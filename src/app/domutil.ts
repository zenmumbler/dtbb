...
export function elem<T extends HTMLElement>(sel: string, base: ParentNode = document) {
	return base.querySelector(sel) as T;
}


export function elemList<T extends HTMLElement>(sel: string, base: ParentNode = document) {
