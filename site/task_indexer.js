...
var promisedDb = createCommonjsModule(function (module, exports) {
...
(function (factory) {
    if ('object' === "object" && 'object' === "object") {
        ...
        undefined(["require", "exports"], factory);
    }
...
var promisedDb_1 = promisedDb.PromisedDB;

var DB_NAME = "dtbb";
var CatalogPersistence = (function () {
    function CatalogPersistence() {
        this.db_ = new promisedDb_1(DB_NAME, 1, function (db, _oldVersion, _newVersion) {
